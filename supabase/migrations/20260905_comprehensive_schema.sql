-- ═══════════════════════════════════════════════════════════════
-- ChirplyMint — Migration 20260905: Comprehensive Schema
-- Covers all missing tables, columns, indexes, RLS policies, and RPCs
-- ═══════════════════════════════════════════════════════════════

-- Utility RPC: Atomic field increment
