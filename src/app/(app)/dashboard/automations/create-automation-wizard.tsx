...
export default function CreateAutomationWizard({
  ...
  async function handleCreate() {
    ...
    fd.set("comment_reply_enabled", formData.comment_reply_enabled ? "true" : "false");
        ...
        <div className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    >
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">Trigger on any post or reel</p>
                    </button>
                    <button
                      type="button"
                      onClick={() =>
                    ...
                    >
                      ...
                      />
                      <p className="text-sm font-semibold text-foreground">Specific Post</p>
                      <p className="text-xs text-muted-foreground mt-0.5">Choose a post from your feed</p>
                    </button>
                  </div>
                </div>
              )}
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-2 max-h-64 overflow-y-auto rounded-xl border border-border p-2 bg-background">
                      {stories.map((story) => (
                        ...
                        >
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img
                            src={story.media_type === "VIDEO" ? story.thumbnail_url : story.media_url}
                            alt="Story"
                  ...
                  {loadingPosts ? (
                    ...
                    <>
                      ...
                      {nextCursor && (
                        ...
                        >
                          {loadingMorePosts ? <Loader2 className="w-4 h-4 animate-spin" /> : null}
          ...
          {step === 2 && (
            <div className="space-y-5">
              ...
              {formData.template_type === "text" && (
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-foreground">DM Message Template</label>
                  <textarea
                    value={formData.dm_template}
                    onChange={(e) => setFormData((f) => ({ ...f, dm_template: e.target.value }))}
                    rows={4}
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {["{name}", "{keyword}"].map((v) => (
                      <button
                        type="button"
                        key={v}
                        onClick={() => setFormData((f) => ({ ...f, dm_template: f.dm_template + ` ${v}` }))}
              ...
              {formData.template_type === "button" && (
                <div className="space-y-4">
                  ...
                  {/* Title */}
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-foreground">Card Title <span className="text-red-400">*</span></label>
                    <input
                  ...
                  {/* Subtitle */}
                  <div className="space-y-1.5">
                    <label className="text-sm font-medium text-foreground">Subtitle <span className="text-muted-foreground">(optional)</span></label>
                    <input
                        ...
                        <div className="rounded-xl overflow-hidden border border-border shadow-sm bg-card">
                          ...
                          <div className="p-3.5">
                            ...
                            {formData.template_subtitle && (
                              <p className="text-xs text-muted-foreground mt-0.5">{formData.template_subtitle}</p>
                            )}
                          </div>
                          {formData.template_buttons.length > 0 && (
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setFormData((f) => ({ ...f, require_follow: !f.require_follow }));
                    }}
                  ...
                  >
                    <span
                      className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-transform ${
                        formData.require_follow ? "translate-x-5" : "translate-x-0"
                      }`}
                    />
                  </button>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() => setFormData((f) => ({ ...f, ai_enabled: !f.ai_enabled }))}
                    className={`relative w-11 h-6 rounded-full transition-colors ${
                      formData.ai_enabled ? "bg-purple-500" : "bg-muted-foreground/30"
                    }`}
                  >
                    <span
                      className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-transform ${
                ...
                {formData.ai_enabled && (
                  <div className="mt-3 space-y-1.5">
                    <label className="text-xs font-medium text-foreground">AI Persona (optional)</label>
                    <input
                      value={formData.ai_persona}
                      onChange={(e) => setFormData((f) => ({ ...f, ai_persona: e.target.value }))}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <button
                    type="button"
                    onClick={() => setFormData((f) => ({ ...f, comment_reply_enabled: !f.comment_reply_enabled }))}
                    className={`relative w-11 h-6 rounded-full transition-colors ${
                      formData.comment_reply_enabled ? "bg-blue-500" : "bg-muted-foreground/30"
                    }`}
                  >
                    <span
                      className={`absolute top-0.5 left-0.5 w-5 h-5 rounded-full bg-white shadow-sm transition-transform ${
                        formData.comment_reply_enabled ? "translate-x-5" : "translate-x-0"
                      }`}
                    />
                  </button>
                </div>
                {formData.comment_reply_enabled && (
                  <div className="mt-3 space-y-1.5">
                    <label className="text-xs font-medium text-foreground">Reply Message</label>
                    <input
                      value={formData.comment_reply_template}
                      onChange={(e) => setFormData((f) => ({ ...f, comment_reply_template: e.target.value }))}
            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-border bg-background p-5 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-foreground">{formData.name}</h3>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/30">
                    ...
                    <div>
                      <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Trigger Keywords</p>
                      <div className="flex flex-wrap gap-1 mt-1">
                        {formData.keyword.split(",").map((kw, i) => (
                          <span key={i} className="inline-flex px-2 py-0.5 rounded-md bg-[oklch(0.52_0.19_162/10%)] text-[oklch(0.52_0.19_162)] text-xs font-mono font-medium">
                            {kw.trim()}
                          </span>
                        ))}
                      </div>
