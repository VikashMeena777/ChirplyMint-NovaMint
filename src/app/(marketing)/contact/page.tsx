    ...
    <div className="max-w-5xl mx-auto py-16 px-6">
      ...
      <div className="grid md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-3">
          {isSubmitted ? (
            <div className="flex flex-col items-center justify-center text-center p-12 rounded-2xl bg-white border border-border shadow-sm">
            ...
            <form
              ...
              className="p-6 rounded-2xl bg-white border border-border shadow-sm space-y-4"
            >
